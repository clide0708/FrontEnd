  ...
  <div class="container">
    <div class="nav-bar">
      ...
      <ul class="nav-menu" id="navMenu">
        ...
        <li><a href="../Treinos/treinos.php" class="<?= basename($_SERVER['PHP_SELF']) == 'treinos.php' || basename($_SERVER['PHP_SELF']) == 'academia.php' || basename($_SERVER['PHP_SELF']) == 'calistenia.php' ? 'active' : '' ?>">Treinos</a></li>
